...
final class BuildSettings: NSObject {
    ...
    static let applicationWebAppUrlString = "https://app.discov.ru/sfera/"
    ...
    static var serverConfigDefaultHomeserverUrlString: String {
        MDMSettings.serverConfigDefaultHomeserverUrlString ?? "https://discov.ru"
    }
    ...
    static var serverConfigSygnalAPIUrlString: String {
        MDMSettings.serverConfigSygnalAPIUrlString ?? "https://push.discov.ru/_matrix/push/v1/notify"
    }
    ...
    static let applicationPrivacyPolicyUrlString = "https://github.com/makssnin/sfera-ios/blob/main/PRIVACY.md"
...
//        "www.example.com": ["/"],
    ...
    struct AnalyticsConfiguration {
        ...
        let termsURL: URL = URL(string: "https://sfera.app/privacy")!
    }
