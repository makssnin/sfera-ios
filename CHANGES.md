## Changes in 1.0.0 (2025-11-26)

✨ Features

- The app has been rebranded to Sfera / Sfera Chat, including the updated application name and new visual identity.

- Updated all application icons and branding assets.

🙌 Improvements

- Updated default homeserver configuration.

- Updated push gateway settings to use the new service endpoint.

- Fully disabled analytics and telemetry collection.

- Updated build configuration for compatibility with the current toolchain.

🐛 Bugfixes

- Fixed an issue where the selected application language was not applied correctly.

- Fixed incorrect rendering of the session management menu.

- Updated application bundle identifiers and ensured consistency across all targets.

🧱 Build

- Updated app identifiers and provisioning configuration to align with the new branding.
